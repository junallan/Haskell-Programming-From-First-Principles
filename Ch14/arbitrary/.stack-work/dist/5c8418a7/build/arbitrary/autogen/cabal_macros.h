...
/* package arbitrary-0.1.0.0 */
#ifndef VERSION_arbitrary
#define VERSION_arbitrary "0.1.0.0"
#endif /* VERSION_arbitrary */
#ifndef MIN_VERSION_arbitrary
#define MIN_VERSION_arbitrary(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_arbitrary */
...
#define CURRENT_COMPONENT_ID "arbitrary-0.1.0.0-6wBPFUbftTw3CpXquhqa5f-arbitrary"
